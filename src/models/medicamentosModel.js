...
export const insertarMedicamento = async (id_consulta, nombre_medicamento, fecha_registro, fecha_hasta) => {
    try {
        ...
        `
        const [results] = await connection.execute(query, [id_consulta, nombre_medicamento, fecha_registro,fecha_hasta])
        return results
    } catch (error) {
...
export const obtenerMedicamentoPorId = async (id_medicamento, id_consulta) => {
    try {
        ...
        `
        const [results] = await connection.execute(query,[id_medicamento,id_consulta])
        return results
    } catch (error) {
